...
writers.filter(writer=>writer.alive==true).forEach(writer=>console.log(
  `Hi, my name is  ${writer.firstName} ${writer.lastName}. I was ${writer.age} years old, and worked as a ${writer.occupation}.`))
/*
