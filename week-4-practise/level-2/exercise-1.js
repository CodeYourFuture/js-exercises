...
var bottle = {
  volume: 0,
  fill: function() {
    return (bottle.volume = 100); // calling this function should make you bottles volume = 100;
  },
  drink: function() {
    return (bottle.volume -= 10); // calling this function should decrease your bottles volume by 10;
  },
  empty: function() {
    return (bottle.volume = 0); // this function should return true if your bottles volume = 0
  }
};
