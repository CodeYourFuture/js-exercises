...
{owner} - github username,  {repo} - repository name, {pull_number} - Lists details of a pull request , /comments  -  comments of a pull request
...
https://github.com/CodeYourFuture/js-exercises/pull/731
