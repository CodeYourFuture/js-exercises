...
let coffeeMachine = {
  ...
  getCoffee: function (coffee) {
    for (let coffeeChoice in this.prices) {
      if ((coffeeChoice = coffee)) {
        return this.prices[coffeeChoice] <= this.insertedAmount
          ? `'Please take your ${coffee}'`
          : `'Sorry you don't have enought money for a ${coffee}'`;
      }
    }
  },
};
