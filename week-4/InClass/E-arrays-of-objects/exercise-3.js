...
// // var res1 = Object.values(restaurants[0]);
...
// //         return this.restaurants.filter((availableSeatsCheck) => availableSeatsCheck.totalSeats - availableSeatsCheck.numberOfCustomers > numberOfPeople).map(availablerestoSeats => {
// //             return availablerestoSeats.name
// //         })// Complete here
// //     },
