...
function getOwnerFullName(house) {
   return house.currentOwnerFullName;
}
var currentHouseOwner = getOwnerFullName(parkAvenueHouse)
console.log(currentHouseOwner);

 
var currentHouseOwner = getOwnerFullName(kinningParkHouse)
console.log(kinningParkHouse);
