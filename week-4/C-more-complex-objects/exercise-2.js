...
//console.log(house.previousOwners);  before
house.previousOwners[1] = "Stephen B";

//remove = house.previousOwners.splice(1, 1, "Stephen B");
//console.log(house.previousOwners);  after
//house.previousOwners = house.previousOwners.splice(1, 1, "Stephen B");
