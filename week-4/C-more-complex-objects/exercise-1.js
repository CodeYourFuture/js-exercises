...
house.previousOwners = ["Brain M.", "Fiona S."];
...
console.log(
  "Expected result: 51 Berkley Road. Actual result: " + house.address.toString()
);
console.log(
  "Expected result: Brian M., Fiona S. Actual result: " + house.previousOwners
);
console.log(
