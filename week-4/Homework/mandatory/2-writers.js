...
*/
let writerAlive= writers.filter(n=>n.alive === true).forEach(n=> console.log(`Hi, my name is ${n.firstName} ${n.lastName}. I am ${n.age} years old, and work as a ${n.occupation}."`))
