...
let bottle = {
  volume: 0,
  fillUp: function () {
    this.volume += 100; // calling this function should pour your bottle full (volume = 100);
  },
  pour: function () {
    this.volume === this.volume + 10; // calling this function should increase your bottle volume by 10 unit;
  },
  drink: function () {
    this.volume -= 10; // calling this function should decrease your bottle volume by 10 unit;
  },
  isFull: function () {
  ...
  isEmpty: function () {
    // this function should return true if your bottle is is empty;
    if (this.volume === 0) {
      return true;
    }
  },
