...
Extra question:
  ...
  `this` is a javascript keyword used to access the information stored in the object, it is prefer using `this` to make 
  our code more reliable and with less syntax error.
*/
