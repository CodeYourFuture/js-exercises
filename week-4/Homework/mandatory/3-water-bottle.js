...
let bottle = {
  ...
  drink: function() {
    this.volume -= 10
    console.log(`Bottle volume is ${this.volume}`)// calling this function should decrease your bottles volume by 10;
  },
  empty: function() {
    (this.volume === 0) ? true : false// this function should return true if your bottles volume = 0
  }
};
