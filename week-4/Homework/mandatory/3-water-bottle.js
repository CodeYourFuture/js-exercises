...
// it's perferd to use 'this' in large/big objects and in general to make it easier to call the object since it's easy to foget the variables names if there was mutiple objects in the same code.
