...
// If you decide to change the name of the Object, it will be easier and faster to use `this` over the variable name otherwise you would have to go through each line changing it's name individually.
