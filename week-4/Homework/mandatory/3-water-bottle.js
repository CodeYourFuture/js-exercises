...
// it is easier than keeping typying the name of the object and if we decide to change the name of the object ,the corresponded funtictions will not be affected
/*
