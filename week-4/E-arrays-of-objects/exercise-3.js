...
*/
function getRestaurantRestName(rest) {
  return rest.name;
}
var restaurantFinderApplication = {
  ...
  findAvailableRestaurants: function(numberOfPeople) {
    var findRestaurant = restaurants.filter(function(rest) {
      return rest.totalSeats - rest.numberOfCustomers >= numberOfPeople;
    });
    return findRestaurant.map(getRestaurantRestName);
  },
  // Complete here
  ...
  findRestaurantServingDish: function(dishName) {
    ...
    return findDishes.map(getRestaurantRestName);
    // Complete here
  },
