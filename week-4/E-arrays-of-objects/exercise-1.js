...
var personNames = persons.map(eachName => eachName.name); // Complete here

var personsYoungerThan28YearsOld = persons.filter(isYoungerThan28YearsOld); // Complete here

function isYoungerThan28YearsOld(old) {
  return old.age < 28;
}
/*
