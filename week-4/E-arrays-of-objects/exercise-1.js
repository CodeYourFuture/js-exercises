...
var personNames = persons.map(names); // Complete here

function YoungerThan28Years(person) {
  if (person.age < 28) {
    return [person.name];
  }
}
var personsYoungerThan28YearsOld = persons.filter(YoungerThan28Years); // Complete here
