...
var personNames = ["Alice", "Bob", "John"];

var personsYoungerThan28YearsOld = [25, 20, 30];

var names = function() {
  return personNames.map();
};

var age = function() {
  return personsYoungerThan28YearsOld.filter(
    age > personsYoungerThan28YearsOld
  );
};
/*
