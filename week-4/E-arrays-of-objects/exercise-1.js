...
const predicrateFunction = person => person.age < 28;
const personsYoungerThan28YearsOld = persons.filter(predicrateFunction).map(getName) // Complete here // Complete here
    /*
