...
var destinationNamesWithin500Kms = ["Edinbrough", "Dublin"];
function travel() {
  return destinationNamesWithin500Kms.filter(travel);
}
var destinationNameReachableByFerry = ["Dublin"];
function ferry() {
  return destinationNameReachableByFerry.find(furry);
}
var destinationNamesMoreThan300KmsAwayByTrain = ["Dublin", "Paris", "london"];
