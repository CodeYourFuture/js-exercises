...
var destinationNamesWithin500Kms = travelDestinations.filter(
  destinationNamesWithin500Kms <= 500
); // Complete here

var destinationNameReachableByFerry = trasportation.find("ferry"); // Complete here

var destinationNamesMoreThan300KmsAwayByTrain = destinationNamesMoreThan300KmsAwayByTrain.every(
  destinationName,
  distanceKms
