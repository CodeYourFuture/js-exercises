...
var bush1SafeToEat = bush1BerryColours.every(x => x==='pink'); //Complete this statement
var bush2SafeToEat = bush2BerryColours.every(x => x === 'pink'); //Complete this statement
