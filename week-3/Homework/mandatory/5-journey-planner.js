...
*/
function isAccessibleByTransportMode(arrTrans, aTrans) {
  return arrTrans.includes(arrTrans);
}
...
function journeyPlanner(locations, transportMode) {
  ...
  let NewTrsns = getTransportModes(locations);
  locations.filter(isAccessibleByTransportMode(locations, transportMode));
}
