...
*/
function isAccessibleByTransportMode(a, b) {
  return a.includes("b");
}
...
function journeyPlanner(locations, transportMode) {
  let checkTransport = locations.filter((i) => i.includes(transportMode));
  let result = checkTransport.map((i) => i[0]);
  return result;
