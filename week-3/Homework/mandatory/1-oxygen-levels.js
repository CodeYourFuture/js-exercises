...
//.map - loops through array, checks against condition / we can apply changes by looping through array.

function safeLevels(oxygenLevel) {
  let foundPlanet = oxygenLevel.find(element => element > "19.5%" && element < "23.5%")
  return foundPlanet
}
/* ======= TESTS - DO NOT MODIFY ===== */
