...
*/
//The program throws an error because b is not defined
//console.log(b); removed
//2 6, 4, 9, 6, 13, 8 
//f1 called twice
//f2 called thrice
// a parameter takes 7 in the first
// "a" paremeter takes 6 in the outer variable when
//
...
const f1 = function (a, b) {
  // a = i, b = a from the "else" statement dealing [odd numbers]. // 1st time f1 is called the argument is (a = 1 , b = 8)  //  2nd time f1 is called the argument is (a = 3, b = 10)
  return a + b;
...
const f2 = function (a, b) {
  ...
  return a + b + x;
  // 1st f2 result (a = 0) + (b = 2) + (x = 2) = [ 4 ]  // 2nd f2 result (a = 2) + (b = 2) + (x = 2) = [ 6 ]   // 3rd f2 result (a = 4) + (b = 2) + (x = 2) = [ 8 ]
}
console.log(x);
console.log(a);
//console.log(b); == Task 1 - answer - error - no variable assigned
//Task 2 -
for (let i = 0; i < 5; ++i) {
  // for loop result of [let i ] = 0,1,2,3,4 is less then 5 and then the loop ends.
  a = a + 1;
  //  a is a new variable = old variable + 1 = answer new variable // new variable a = 7, 8, 9, 10, 11
  if (i % 2 === 0) {
