...
// Table of values resulting from the function evaluating odd even numbers using for loop if else statement 
/-------------------------------------------------------------------------------------------------
//   x   |   -  |      a       |        -      |   -   |   -   |   -    |   -   |   -   |   -    |
//------------------------------------------------------------------------------------------------
//   2   |   -  |      6       |        -      |   -   |   -   |   -    |   -   |   -   |   -    |
/-------------------------------------------------------------------------------------------------
//   -   |   -  | oldValue = a | newValue = a  |   f2  |  f1   |   -   |   -    |  odd   |  even |
/-------------------------------------------------------------------------------------------------
...
//function f1 only deals odd numbers
...
//function f2 only deals even numbers
...
}//stops when for reach number 4 loop.
