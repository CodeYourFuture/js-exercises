...
/*
  ...
  1. This program throws an error. Why? (If you can't find it, try executing it). on line 37 "b" is not defined
  2. Remove the line that throws the error.
  3. What is printed to the console? I can't undrestand what this question exactly asking. there are 4 console, which one is the question pointed to?
