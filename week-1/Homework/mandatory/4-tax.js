...
function calculateSalesTax(price) {
  let calculateTax = (price * 20) / 100;
  let finalprice = calculateTax + price;

  return finalprice;
}
console.log(calculateSalesTax(40));
/*
  CURRENCY FORMATTING
  ===================
...
function formatCurrency(currency) {
  let thisPrice = calculateSalesTax(currency);
  return "£" + thisPrice.toFixed(2);
}
