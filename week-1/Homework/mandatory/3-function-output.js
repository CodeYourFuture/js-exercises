...
function getNumber() {
  ...
  // The Math.random() function returns a floating - point, pseudo - random number in the range 0 to less than 10(inclusive of 0, but not 10).
}
...
function s(w1, w2) {
  ...
  // s will give return these two glued together, for example if w1=a and w2=b, s will return ab.
}
