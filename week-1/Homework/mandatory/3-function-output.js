...
// this function returns a random number between 0 and 1 using the method Math.random and multiplies it by 10

// Add comments to explain what this function does. You're meant to use Google!
function s(w1, w2) {
    return w1.concat(w2);
}
// this function concatenates two strings called w1 and w2
