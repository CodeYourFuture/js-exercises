...
// The function getNumber generates a random number between 0 and 1 and this number gets multiplied by 10 to return a whole number
function getNumber() {
    return Math.random() * 10;
}

// Add comments to explain what this function does. You're meant to use Google!
// The function s invokes the concat method on parameter 1 and adds to it parameter 2 
function s(w1, w2) {
    return w1.concat(w2);
}
