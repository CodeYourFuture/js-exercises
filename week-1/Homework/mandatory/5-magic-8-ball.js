...
function shakeBall() {
  ...
  const options= ["It is certain",
    ...
    "Outlook not so good",
    "Very doubtful"];
  return `${options[randomNumberFloor]}`;
}
...
function checkAnswer(answer) {
  ...
  if(answer=="As I see it, yes"|| answer=="Most likely" || answer=="Outlook good"||answer=="Yes"||answer=="Signs point to yes")
  {
    levelOfPositivity="positive"; 
  }

  if(answer=="Reply hazy, try again"|| answer=="Ask again later" || answer=="Better not tell you now"||answer=="Cannot predict now"||answer=="Concentrate and ask again")
  {
    levelOfPositivity="negative"; 
  }

  if(answer=="Don't count on it"|| answer=="My reply is no" || answer=="My sources say no"||answer=="Outlook not so good"||answer=="Very doubtful")
  {
