...
function convertToUSD(sterlingPrice) {
  const usdPrice = sterlingPrice * 1.4;
  return usdPrice;
}
...
function convertToBRL(sterlingPrice) {
  const brlPrice = sterlingPrice * 5.7;
  const finalPrice = brlPrice + brlPrice / 100;
  return finalPrice;
}
