...
function convertToUSD(price) {
  const convertingPrices = price * 1.4;
  return convertingPrices;
}
...
function convertToBRL(price) {
  const convertedToReal = price * 5.7;
  const calculatingFee = convertedToReal / 100;
  return convertedToReal + calculatingFee;
}
