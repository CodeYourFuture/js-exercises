...
function convertToUSD(GBprice) {

  const usdPrice = GBprice * 1.4;
...
function convertToBRL(GBprice) {

const brlPrice = GBprice * 5.7;

let transactionFee = 0.01*brlPrice;

return brlPrice + transactionFee;
