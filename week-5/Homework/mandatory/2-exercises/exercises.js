...
function exerciseOne(arrayOfPeople) {
  ...
  function namesList(){
    ...
    for (let i = 0; i < arrayOfPeople.length; i++) {
      ...
      firstHeading.innerHTML = arrayOfPeople[i].name;
  }
     ...
     function jobsList(){
       ...
       for (let j = 0; j < arrayOfPeople.length; j++) {
         ...
         secondHeading.innerHTML = arrayOfPeople[j].job;
...
function exerciseThree(books) {
  ...
  for(let i = 0; i < books.length;i++){
     ...
     let pragraphContainer = document.createElement('p');
     listItem.appendChild(pragraphContainer);
     listItem.style.backgroundColor= book.alreadyRead ? 'green':'red';
     pragraphContainer.textContent = `${book.title} - ${book.author}`;
