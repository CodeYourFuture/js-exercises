...
function exerciseOne(arrayOfPeople) {
  let content = document.querySelector("#content"); // find an element, and returns the first element with "IDcontent"
  for (let i = 0; i < arrayOfPeople.length; i++) { //we created a for loop to get all the items from the object returning an array
    let person = arrayOfPeople[i];
    //how to create an element h1 and h2
 ...
 *
 * All of your HTML should go inside the Div tag with the id "content".
 * refers to textContent - https://developer.mozilla.org/en-US/docs/Web/API/Node/textContent is the as textNodecreate
...
function exerciseTwo(shopping) { // create a function that will create a shopping list of 
  let content = document.querySelector("#content");
  let shoppingList = document.createElement("ul");
  shopping.forEach(function (item) {
    let listItem = document.createElement("li");
    listItem.textContent = item;
    shoppingList.appendChild(listItem); //li element is the child of the ul(parent)
  });
