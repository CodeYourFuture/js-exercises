...
function exerciseOne(arrayOfPeople) {
  ...
  arrayOfPeople.map(function(names) {
    let h1 = document.createElement("h1");
    let h2 = document.createElement("h2");
    h1.innerHTML = names.name;
    h2.innerHTML = names.job;
...
**/
let contentBooks = document.querySelector("body");
let ul = document.createElement("ul");
contentBooks.appendChild(ul);
ul.setAttribute(
  "style",
  "display: flex; justify-content: space-around; flex-wrap: wrap; margin: 0 auto"
);

function exerciseThree(books) {
  books.map(function(allBooks) {
    let li = document.createElement("li");
    ul.appendChild(li);
    li.setAttribute(
      "style",
      "list-style-type: none; background-color: red; width: 400px; padding: 20px; margin: 20px"
    );
    if (allBooks.alreadyRead) {
    ...
    li.appendChild(p);
    p.innerHTML = allBooks.title + " - " + allBooks.author;
  ...
  allAnchors[1].href =
    "https://www.amazon.co.uk/Most-Human-Artificial-Intelligence-Teaches/dp/0307476707";
  allAnchors[1].target = "_blank";
  allAnchors[2].href =
    "https://www.amazon.co.uk/Pragmatic-Programmer-Journeyman-Master-ebook/dp/B003GCTQAE/ref=sr_1_2?crid=SIW6GDBGQDY3&dchild=1&keywords=the+pragmatic+programmer&qid=1585852609&s=books&sprefix=the+pra%2Cstripbooks%2C164&sr=1-2";
  allAnchors[2].target = "_blank";
}
