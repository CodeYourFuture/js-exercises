...
submitButton.addEventListener("click", function(){
    ...
    let yourEmail = document.querySelector("#example-text-input");
    let describeYourself = document.querySelector("#exampleTextarea");

    let emailInput = email.value
    let yourEmailValue = yourEmail.value
    let describeYourself = describeYourself.value
...
function checkTheForm(email, yourEmail, describeYourself) {
