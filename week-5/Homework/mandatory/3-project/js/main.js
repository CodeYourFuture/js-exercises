...
let myInput1 = MyArrayOfMyRegisterInput[0].querySelector("input");
let myInput2 = MyArrayOfMyRegisterInput[1].querySelector("input");
let myInput3 = MyArrayOfMyRegisterInput[2].querySelector("#exampleTextarea");

function checkValid(event) {
  if (!(myInput1.value.length > 0) || !myInput1.value.split("").includes("@")) {
    myInput1.style.backgroundColor = "red";
    myInput1.placeholder = "please try again";
  ...
  if (!(myInput3.value.length > 0)) {
    myInput3.style.backgroundColor = "red";
    event.preventDefault();
  }
  if (
    myInput3.value.length > 0 &&
    !(myInput2.value.length > 0) &&
    myInput1.value.length > 0 &&
    myInput1.value.split("").includes("@")
  ) {
    myInput2.style.backgroundColor = "red";
    event.preventDefault();
  }
  if (
    myInput3.value.length > 0 &&
    myInput2.value.length > 0 &&
    (!(myInput1.value.length > 0) || !myInput1.value.split("").includes("@"))
  ) {
    myInput1.style.backgroundColor = "red";
    myInput1.placeholder = "please try again";
    event.preventDefault();
