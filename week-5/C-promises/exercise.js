...
function exercise1() {
  ...
  myPromise.then(function(textContent) {
    console.log("A Promising Promise" + textContent);
  });
}
...
function exercise2() {
  ...
  myPromise.catch(function (textContent) {
    console.log("A Unpromising Promise"+ textContent);
  });
}
