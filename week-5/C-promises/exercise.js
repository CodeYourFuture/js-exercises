...
*/
function exercise3() {
  var promise3 = delayedPromise().then(function(resolve) {
    document.getElementById("exercise3").textContent = resolve;
  });
}
...
*/
function exercise4() {
  var promise4 = concatPromise().then(function(resolve) {
    document.getElementById("exercise4").textContent = resolve + "Ahmed";
  });
}
...
function exercise5() {
  var Promise5 = promiseThatResolved().then(function(resolve) {
    document.getElementById("exercise5").textContent = resolve;
  });
  // Write your implementation here
}
function promiseThatResolved() {
...
*/
function exercise6() {
  var promise6 = promiseThatRejected().catch(function(reject) {
    document.getElementById("exercise6").textContent = reject;
  });
  // Write your implementation here
}
function promiseThatRejected() {
