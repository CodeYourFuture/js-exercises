...
function exercise1() {
  ...
  promise1.then(text => {
    document.querySelector("#exercise1").textContent = text;
  });
}
...
function exercise2() {
  ...
  promise2.catch(err => {
    document.querySelector("#exercise2").textContent = err;
  });
}
...
function exercise4() {
  ...
  promise4.then(text => {
    document.querySelector("#exercise4").textContent = text + "Yousef Saghir";
  });
}
...
function exercise5() {
  ...
  Promise5.then(text => {
    document.querySelector("#exercise5").textContent = text;
  });
...
function exercise6() {
  ...
  Promise6.catch(text => {
    document.querySelector("#exercise6").textContent = text;
  }); // Write your implementation here
}
