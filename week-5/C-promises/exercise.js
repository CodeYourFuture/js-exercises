...
*/
function exercise1() {
  var promise1 = resolvedPromise().then(value => {
...
*/
function exercise2() {
  var promise2 = rejectedPromise().catch(value => {
...
function exercise4() {
  var promise4 = concatPromise().then(value => {
    return Promise.resolve(value + " Ali").then(value2 => {
...
function exercise5() {
  ...
  Promise.resolve("Hello Promises!").then(value => {
...
function exercise6() {
  // Write your implementation here
  Promise.reject("Something went wrong!").catch(value => {
