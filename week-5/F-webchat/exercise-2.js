...
var addMassege = document.getElementById("submit");
addMassege.addEventListener("click", sendMassegeToList);

function sendMassegeToList() {
  var message = document.getElementById("message-input").value;
  document.getElementById("message-input").value = "";

  var requestBody = { content: message };
