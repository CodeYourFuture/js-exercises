...
function exercise2(result) {
  ...
  let myResult = document.querySelector('#exercise2');
...
function exercise3(callback) {
  let myHello = document.querySelector('#exercise3');
  myHello.innerText = "Hello form the callback";
