...
function exercise1() {
  var newText = document.querySelector("#exercise1");
  newText.innerHTML = "Flaminia";
}
...
function exercise2(result) {
  var addIt = document.getElementById("exercise2");
  addIt.innerText = result;
}
...
/*
  ...
  comment below (Hint: look below to see where exercise3 is called) The callback takes the result as a parameter and
  it is attributed to exercise3 with the "querySelector" method
*/
