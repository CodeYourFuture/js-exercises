...
function exercise1() {
  ...
  //document.getElementsByTagName("h3").innerText = "deepa";
  document.getElementById("exercise1").innerHTML = "deepa";
}
...
function exercise2(result) {
  document.getElementById("exercise2").innerHTML = result;
}
...
function exercise3(callback) {
  ...
  callback("hello From the call back");
}
