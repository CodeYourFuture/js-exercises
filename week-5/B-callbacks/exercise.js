...
// var updateButtonValue = document.querySelector("#button1");
// updateButtonValue.addEventListener("click", exercise1);

document.querySelector("#button1").addEventListener("click", exercise1);

function exercise1() {
  // Write your implementation here
  var value = document.querySelector("#button1");
  value.textContent = "Foluke";
}
...
function exercise2(result) {
  // Write your implementation here
  //var passValue = document.getElementById("exercise2");
  var newPar = document.querySelector("#exercise2");
  //passValue.textContent = "Hello from the function caller";
  newPar.textContent = "Hello from the function caller";
}
