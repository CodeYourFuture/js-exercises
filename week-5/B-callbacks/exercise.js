...
function exercise1() {
  document.querySelector("#exercise1").textContent = "Teresa"; // Write your implementation here
}
...
function exercise2(result) {
  document.querySelector("#exercise2").textContent = result; // Write your implementation here
}
