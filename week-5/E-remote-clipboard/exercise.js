...
var clipboardTitle = "Rajkey";
var clipboardText = "Raj";
...
fetch('https://codeyourfuture.herokuapp.com/api/clipboard?title=Rajkey').then(function(response) {
    return response.text();
}).then(function (clipboard){
    // console.log(clipboard);
    greetingText.innerText = clipboard;
});
