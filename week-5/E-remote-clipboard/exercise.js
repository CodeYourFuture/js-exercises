...
var clipboardTitle = "myFirstClipboard";
var clipboardText = "You know nothing JavaScript!";
...
fetch(
  "https://codeyourfuture.herokuapp.com/api/clipboard?title=myFirstClipboard"
)
  .then(response => {
