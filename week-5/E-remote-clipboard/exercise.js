...
var clipboardTitle = "matthew";
var clipboardText = "Hello CodeYourFuture!";
...
var url = "https://codeyourfuture.herokuapp.com/api/clipboard?title=";
var additionalParams = clipboardTitle;
var combinedURL = `${url}${additionalParams}`;
