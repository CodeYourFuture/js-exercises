...
var clipboardTitle = "newTitle";
var clipboardText = "Alisina's Clipboard";
...
fetch(
  ...
  .then(()=>{
    fetch("https://codeyourfuture.herokuapp.com/api/clipboard?title=newTitle")
  .then(function (response) {
      return response.text();
  })
    .then(function (clipboardTitle) {
        document.getElementById("greeting-text").textContent = clipboardTitle;
