...
let photoArray = [
  ...
  let newPhoto = document.getElementById("submitButton");
  newPhoto.addEventListener("click", function(event) {
    event.preventDefault();
    let getnewURL = document.getElementById("nphoto").value;
    photoArray.push(getnewURL);
  });